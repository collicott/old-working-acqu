...
Int_t eg[] = { 240, 243, 245, 247, 250, 252, 255, 257, 260, 262, 264, 267, 269, 272, 274, 277, 279, 281, 284, 286, 289, 291, 294, 296, 298, 301, 303};
Int_t th[] = { 0, 10, 30, 50, 70, 90, 110, 130, 150, 170};
Int_t tchan[] = { 269, 268, 267, 266, 265, 264, 263, 262, 261, 260, 259, 258, 257, 256, 255, 254, 253, 252, 251, 250, 249, 248, 247, 246, 245, 244, 243};

//Int_t eg[] = { 240, 243, 245};
//Int_t th[] = { 0, 10, 30, 50, 70, 90, 110, 130, 150, 170};
//Int_t tchan[] = { 269, 268, 267};

//Int_t eg[] = { 200, 210, 220, 230, 240, 250, 260, 269, 281, 289, 298};
//Int_t th[] = { 0, 10, 30, 50, 70, 90, 110, 130, 150, 170};
...
// reaction.
//
void CompEffBin( Int_t ebin = 1, Int_t tbin = 0, Double_t msep = 940,
...
{
	for ( UInt_t ebin = 0; ebin <= 24; CompEffDiff( ebin++, msep, open_cut));
}

void CompEffDiffAll2( Double_t open_cut = 5)
{
	for ( UInt_t ebin = 0; ebin < 25; CompEffDiff2( ebin++, open_cut));
}
