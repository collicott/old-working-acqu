...
void msepcreator( Double_t open_cut = 5)
{
	...
	name = Form( "       Double_t msep_cut[27][10];");
	cout << name << endl;
	outFile << name << endl;
...
// cout << name << endl;
		...
		if (msepbest == 0) {
		name = Form( "       msep_cut[%1d][%1d] = %1d;      %7.3f , %d", ebin, tbin, msepbest, contout, whichmsep);
		cout << name << endl;
		...
		name = Form( "       msep_cut[%1d][%1d] = %3d;      %7.3f , %d", ebin, tbin, msepbest, contout, whichmsep);
		cout << name << endl;
