...
TFile fperpFile( "Perp.root");
TFile fparaFile( "Para.root");
...
//	pa 	= 0.0833;
//	prompt  = "PhotonPhiCMProtOAMMP_v_PhotonThetaCMProtOAMMP_v_TChanPhotProtOAMMP";
//	random  = "PhotonPhiCMProtOAMMR_v_PhotonThetaCMProtOAMMR_v_TChanPhotProtOAMMR";
//

	pa 	= 0.166667;
	prompt  = "Pi0PhiPrompt_v_Pi0ThetaPrompt_v_TaggerChannelPromptPi0";
	random  = "Pi0PhiRandom_v_Pi0ThetaRandom_v_TaggerChannelRandomPi0";
...
void AsymBin( UInt_t tbin = 0, UInt_t chan_lo = 300, UInt_t chan_hi = 300)
{
	...
	UInt_t DOF = f1->GetNDF();
	red_chisq = f1->GetChisquare()/DOF;
