...
protected:
  ...
  TA2Particle* 	 fParticleInfo;  //Used to store particle information //***
...
public:
  ...
  virtual Bool_t 	GetAnalyseNaI()  const { return fAnalyseNaI;  }
  virtual Bool_t 	GetAnalysePid()  const { return fAnalysePid;  }
  virtual Bool_t 	GetAnalyseMwpc() const { return fAnalyseMwpc; }
...
protected:
  ...
  Int_t* fPIDHitsProton;    //PID elements if Type = 2212 //***
  Int_t* fPIDHitsPion;      //PID elements if Type = 211  //***
  Int_t* fPIDHitsRootino;   //PID elements if Type = 0    //***
