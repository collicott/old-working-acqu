...
/*	fTriggerTree->Branch("BasicVariable",		&fBasicVariable,    	"BasicVariable/I");
	...
	fTriggerTree->Branch("ConfNeutCoplanar",	&fConfNeutCoplanar, 	  "ConfNeutCoplanar/I");
	fTriggerTree->Branch("ConfNeutCoplanarCTrack",	&fConfNeutCoplanarCTrack, "ConfNeutCoplanarCTrack/I");

	fTriggerTree->Branch("MultiplicityOriginal",	&fMultiplicityOriginal,	"MultiplicityOriginal/I");
	...
	fTriggerTree->Branch("MultiplicityNeighbour",	&fMultiplicityNeighbour,"MultiplicityNeighbour/I");

	fTriggerTree->Branch("NaINCluster2",		&fNaINCluster2, 	"NaINCluster2/I");
	fTriggerTree->Branch("BaF2NCluster2",		&fBaF2NCluster2,    	"BaF2NCluster2/I");

	fTriggerTree->Branch("NaINClusterNeighbour",	&fNaINClusterNeighbour, "NaINClusterNeighbour/I");
	fTriggerTree->Branch("BaF2NClusterNeighbour",	&fBaF2NClusterNeighbour,"BaF2NClusterNeighbour/I");

	fTriggerTree->Branch("NaIClusters2",	   	fNaIClusters2, 	    	"NaIClusters2[NaINCluster2]/I");
	fTriggerTree->Branch("NaIClustersNHits2",  	fNaIClustersNHits2, 	"NaIClustersNHits2[NaINCluster2]/I");
	fTriggerTree->Branch("NaIClustersEnergy2", 	fNaIClustersEnergy2,	"NaIClustersEnergy2[NaINCluster2]/I");

	fTriggerTree->Branch("BaF2Clusters2",	   	fBaF2Clusters2,      	"BaF2Clusters2[BaF2NCluster2]/I");
	fTriggerTree->Branch("BaF2ClustersNHits2", 	fBaF2ClustersNHits2, 	"BaF2ClustersNHits2[BaF2NCluster2]/I");
	fTriggerTree->Branch("BaF2ClustersEnergy2",	fBaF2ClustersEnergy2,	"BaF2ClustersEnergy2[BaF2NCluster2]/I");

	fTriggerTree->Branch("MultiplicityGetNClust",	&fMultiplicityGetNClust,"MultiplicityGetNClust/I");
...
*/
	...
	fTriggerTree->Branch("NPi0",			&fNPi0, 	    	"NPi0/I");
	fTriggerTree->Branch("NPionPhoton",		&fNPionPhoton, 	    	"NPionPhoton/I");
	...
	fTriggerTree->Branch("Pi0Energy",		fPi0Energy,	    	"Pi0Energy[NPi0]/D");
	fTriggerTree->Branch("Pi0Theta",		fPi0Theta, 	    	"Pi0Theta[NPi0]/D");
	fTriggerTree->Branch("Pi0Phi",			fPi0Phi, 	    	"Pi0Phi[NPi0]/D");
	fTriggerTree->Branch("Pi0Time",			fPi0Time, 	    	"Pi0Time[NPi0]/D");

	fTriggerTree->Branch("NPrompt",			&fNPrompt, 	   	"NPrompt/I");
	fTriggerTree->Branch("NPromptMM",		&fNPromptMM, 	   	"NPromptMM/I");
	fTriggerTree->Branch("NRandom",			&fNRandom, 	   	"NRandom/I");
	fTriggerTree->Branch("NRandomMM",		&fNRandomMM, 	   	"NRandomMM/I");

	fTriggerTree->Branch("NTaggNPhot",		&fNTaggNPhot,	    	"NTaggNPhot/I");
	fTriggerTree->Branch("NTagg",			&fNTagg,	    	"NTagg/I");

	fTriggerTree->Branch("TaggerChannel",	    	fTaggerChannel,	 	"TaggerChannel[NTagg]/I");

	fTriggerTree->Branch("TaggerPhotonTime",	fTaggerPhotonTime, 	"TaggerPhotonTime[NTaggNPhot]/D");

	fTriggerTree->Branch("MissingMassPrompt",	fMissingMassPrompt,	"MissingMassPrompt[NPrompt]/D");
	fTriggerTree->Branch("MissingMassRandom",	fMissingMassRandom,	"MissingMassRandom[NRandom]/D");

	fTriggerTree->Branch("TaggerChannelPrompt",	fTaggerChannelPrompt,	"TaggerChannelPrompt[NPromptMM]/I");
	fTriggerTree->Branch("TaggerChannelRandom",	fTaggerChannelRandom,	"TaggerChannelRandom[NRandomMM]/I");
	fTriggerTree->Branch("PhotonThetaPrompt",	fPhotonThetaPrompt, 	"PhotonThetaPrompt[NPromptMM]/D");
	fTriggerTree->Branch("PhotonThetaRandom",	fPhotonThetaRandom, 	"PhotonThetaRandom[NRandomMM]/D");
	fTriggerTree->Branch("PhotonPhiPrompt",		fPhotonPhiPrompt, 	"PhotonPhiPrompt[NPromptMM]/D");
	fTriggerTree->Branch("PhotonPhiRandom",		fPhotonPhiRandom, 	"PhotonPhiRandom[NRandomMM]/D");

	fTriggerTree->Branch("NPromptPi0",		&fNPromptPi0, 	   	"NPromptPi0/I");
	fTriggerTree->Branch("NPromptPi0MM",		&fNPromptPi0MM,	 	"NPromptPi0MM/I");
	fTriggerTree->Branch("NRandomPi0",		&fNRandomPi0, 	   	"NRandomPi0/I");
	fTriggerTree->Branch("NRandomPi0MM",		&fNRandomPi0MM,	   	"NRandomPi0MM/I");

	fTriggerTree->Branch("NTaggNPi0",		&fNTaggNPi0,	    	"NTaggNPi0/I");
	fTriggerTree->Branch("NPi0InvariantMass",	&fNPi0InvariantMass,   	"NPi0InvariantMass/I");

	fTriggerTree->Branch("TaggerPi0Time",		fTaggerPi0Time, 	"TaggerPi0Time[NTaggNPi0]/D");

	fTriggerTree->Branch("MissingMassPromptPi0",	fMissingMassPromptPi0,	"MissingMassPromptPi0[NPromptPi0]/D");
	fTriggerTree->Branch("MissingMassRandomPi0",	fMissingMassRandomPi0,	"MissingMassRandomPi0[NRandomPi0]/D");

	fTriggerTree->Branch("Pi0InvariantMass",	fPi0InvariantMass,    	"Pi0InvariantMass[NPi0InvariantMass]/D");
	fTriggerTree->Branch("Pi0InvariantMassPrompt",	fPi0InvariantMassPrompt,"Pi0InvariantMassPrompt[NPromptPi0]/D");
	fTriggerTree->Branch("Pi0InvariantMassRandom",	fPi0InvariantMassRandom,"Pi0InvariantMassRandom[NRandomPi0]/D");

	fTriggerTree->Branch("TaggerChannelPromptPi0",	fTaggerChannelPromptPi0,"TaggerChannelPromptPi0[NPromptPi0MM]/I");
	fTriggerTree->Branch("TaggerChannelRandomPi0",	fTaggerChannelRandomPi0,"TaggerChannelRandomPi0[NRandomPi0MM]/I");
	fTriggerTree->Branch("Pi0ThetaPrompt",		fPi0ThetaPrompt, 	"Pi0ThetaPrompt[NPromptPi0MM]/D");
	fTriggerTree->Branch("Pi0ThetaRandom",		fPi0ThetaRandom, 	"Pi0ThetaRandom[NRandomPi0MM]/D");
	fTriggerTree->Branch("Pi0PhiPrompt",		fPi0PhiPrompt, 		"Pi0PhiPrompt[NPromptPi0MM]/D");
	fTriggerTree->Branch("Pi0PhiRandom",		fPi0PhiRandom, 		"Pi0PhiRandom[NRandomPi0MM]/D");


/*	fTriggerTree->Branch("NPromptTrig",		&fNPromptTrig, 	   	"NPromptTrig/I");
	fTriggerTree->Branch("NRandomTrig",		&fNRandomTrig, 	   	"NRandomTrig/I");

	fTriggerTree->Branch("NTaggNPhotTrig",		&fNTaggNPhotTrig,	"NTaggNPhotTrig/I");
	fTriggerTree->Branch("TaggerPhotonTimeTrig",	fTaggerPhotonTimeTrig, 	"TaggerPhotonTimeTrig[NTaggNPhotTrig]/D");

	fTriggerTree->Branch("MissingMassPromptTrig",	fMissingMassPromptTrig,	"MissingMassPromptTrig[NPromptTrig]/D");
	fTriggerTree->Branch("MissingMassRandomTrig",	fMissingMassRandomTrig,	"MissingMassRandomTrig[NRandomTrig]/D");

	fTriggerTree->Branch("TaggerChannelPromptTrig",	fTaggerChannelPromptTrig,"TaggerChannelPromptTrig[NPromptTrig]/I");
	fTriggerTree->Branch("TaggerChannelRandomTrig",	fTaggerChannelRandomTrig,"TaggerChannelRandomTrig[NRandomTrig]/I");
*/

	fTriggerTree->Branch("NBitPattern",		&fNBitPattern,	    	"NBitPattern/I");
	fTriggerTree->Branch("BitPattern",		fBitPattern,	    	"BitPattern[NBitPattern]/I");
	fTriggerTree->Branch("CBNParticle",		&fCAPPNParticle,	"CBNParticle/I");
	fTriggerTree->Branch("TAPSNParticle",		&fTAPSNParticle,	"TAPSNParticle/I");
	...
	fTaggerChannel[i] = (fLADD->GetHits())[i];
		...
		for (j = 0; j < fNPhoton; j++)  {
			...
			for (k = 0; k < fNProton; k++)  {
				...
				if ( (fTaggerPhotonTime[fNTaggNPhot] >= 90 && fTaggerPhotonTime[fNTaggNPhot] <= 110) ||
...
// Calculate Missing Mass for all pi0
	...
	for (i = 0; i < fNTagg; i++) {
		...
		for (j = 0; j < fNPi0; j++)  {
			...
			if ( (fTaggerPi0Time[fNTaggNPi0] >= 90 && fTaggerPi0Time[fNTaggNPi0] <= 110) ||
			  	(gAR->GetProcessType() == EMCProcess) ) {
			...
			if ( (fTaggerPi0Time[fNTaggNPi0] >=  20 && fTaggerPi0Time[fNTaggNPi0] <=  80) ||
			     (fTaggerPi0Time[fNTaggNPi0] >= 120 && fTaggerPi0Time[fNTaggNPi0] <= 180) ) {
