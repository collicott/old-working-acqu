...
class TA2ThreshPi0 : public TA2Physics {
	...
	protected:
		...
		Int_t* fTChanM2g;           					// tagger channel
		Int_t* fTChanM2gP;
		Int_t* fTChanM2gR;
		Double_t* fM2gTagg;
		Double_t* fM2gTaggP;
...
//// Variables for Chris - DLH 2010.06.04
		Double_t* fP4MissLabTheta;
		Double_t* fP4MissLabThetaP;
		Double_t* fP4MissLabThetaR;
		Double_t* fCutAngle;
		Double_t* fCutAngleP;
		Double_t* fCutAngleR;
		Double_t* fPi0LabThetaProt;
		Double_t* fPi0LabThetaProtP;
		Double_t* fPi0LabThetaProtR;
		Double_t* fProtLabTheta;
		Double_t* fProtLabThetaP;
		Double_t* fProtLabThetaR;
		Double_t* fPi0LabThetaProtCut;
		Double_t* fPi0LabThetaProtCutP;
		Double_t* fPi0LabThetaProtCutR;
		Double_t* fProtLabThetaCut;
		Double_t* fProtLabThetaCutP;
		Double_t* fProtLabThetaCutR;
//// End of Variables for Chris

		UInt_t fLADDmh;
		Int_t* fLADDnhm;
		Int_t** fTChanHitM;
		Double_t** fTaggerTimeM;
		Double_t** fPi0TaggTimeM;

		UInt_t fNTaggPhot;
		Int_t* fTaggPhotHits;
		Double_t* fTaggPhotEnergy;
		Double_t* fTaggPhotTime;
		TLorentzVector* fTaggPhotP4;
...
inline void TA2ThreshPi0::MarkUndefined( Int_t jtagg )
{
	...
	fTChanM2gP[jtagg] = EPhotoUndefined;
	fM2gTaggP[jtagg] = EPhotoUndefined;

	fNPi0PhotP[jtagg] = EPhotoUndefined;
...
//// Variables for Chris - DLH 2010.06.04
	fP4MissLabThetaP[jtagg] = EPhotoUndefined;
	fCutAngleP[jtagg] = EPhotoUndefined;
	fPi0LabThetaProtP[jtagg] = EPhotoUndefined;
	fProtLabThetaP[jtagg] = EPhotoUndefined;
	fPi0LabThetaProtCutP[jtagg] = EPhotoUndefined;
	fProtLabThetaCutP[jtagg] = EPhotoUndefined;
//// End of Variables for Chris
}
...
inline void TA2ThreshPi0::MarkEndBuffer()
{
	...
	fNPi0PhotP[fNprompt] = EBufferEnd;
	fNPi0PhotR[fNrandom] = EBufferEnd;
...
//// Variables for Chris - DLH 2010.06.04
	fP4MissLabThetaP[fNprompt] = EBufferEnd;
	fP4MissLabThetaR[fNrandom] = EBufferEnd;
	fCutAngleP[fNprompt] = EBufferEnd;
	fCutAngleR[fNrandom] = EBufferEnd;
	fPi0LabThetaProtP[fNprompt] = EBufferEnd;
	fPi0LabThetaProtR[fNrandom] = EBufferEnd;
	fProtLabThetaP[fNprompt] = EBufferEnd;
	fProtLabThetaR[fNrandom] = EBufferEnd;
	fPi0LabThetaProtCutP[fNprompt] = EBufferEnd;
	fPi0LabThetaProtCutR[fNrandom] = EBufferEnd;
	fProtLabThetaCutP[fNprompt] = EBufferEnd;
	fProtLabThetaCutR[fNrandom] = EBufferEnd;
//// End of Variables for Chris
}
