...
protected:
  ...
  // Stuff for putting in trigger sections
  Int_t     fNTrigSectFired;        // no of reconstructed trigger sections fired
  Double_t  fTrigThresh;
  Double_t* fETrigSect;
  Int_t     fETrigCBA;
  Int_t     fETrigCBB;
  Int_t     fETrigCBC;
  ...
  // Stuff for using measured thresholds in file
  Bool_t    fUseSingleThresh;
  Bool_t    fUseTrigHist;
  char      fTrigFileName[255];
  TFile*    fTrigFile;
  char      fTrigHistName[255];
  TH1D*     fCBThresholds; 
...
public:
  ...
  virtual void TriggerSections();             // calculate the number of trig sections
  ...
  // Function to return the number of trigger sections fired
  Int_t GetNTrigSectFired(){return fNTrigSectFired;}
  Int_t GetETrigCBA(){return fETrigCBA;}
  Int_t GetETrigCBB(){return fETrigCBB;}
  Int_t GetETrigCBC(){return fETrigCBC;}
  Int_t GetETrigCBD(){return fETrigCBD;}
  Double_t* GetETrigSect(){return fETrigSect;}
