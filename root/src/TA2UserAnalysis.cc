...
enum { EA2Calorimeter, EA2Tagger, EA2LinearPol, EA2CosmicCal,
       EA2CrystalBall, EA2CentralApparatus, EA2TAPS, EA2TAPS2008, EA2TAPS2009, 
       EA2Taps2009LE, EA2GenericApp, EA2Physics, EA2UserPhysics, EA2PhotoPhysics,
       EA2Compton, EA2Cristina, EA2ParaPerpTest, EA2Trigger, EA2ThreshPi0, EA2Efficiency, };
...
//  {"TA2Taps",        EA2Taps},
  ...
  {"TA2Cristina",    EA2Cristina},
  {"TA2ParaPerpTest",EA2ParaPerpTest},
  {"TA2Trigger",     EA2Trigger},
...
//  case EA2Taps:
  ...
  case EA2Cristina:
    // Cristina
    return new TA2Cristina( name, this );
  case EA2ParaPerpTest:
    // Cristina Compton
    return new TA2ParaPerpTest( name, this );
  case EA2Trigger:
    // Trigger
    return new TA2Trigger( name, this );
  case EA2ThreshPi0:
    // Pi0 threshold
